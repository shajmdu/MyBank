...
public class NewEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Assitant Manager", "Cashier", "Clerk" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Madurai", "Chennai", "Tirupur", "Tirunelveli", "Tanjore" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
                ps = con.prepareStatement(FileReader.getInstanceFR().getInstanceMA().getSql_New_Employee());
